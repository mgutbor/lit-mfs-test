...
**Estado actual:** Completada. T-25 a T-28 están implementados y la Fase 4 ha sido validada.
...
**Estado actual:** Completada. T-29, T-30, T-31 y T-32 implementados y validados.

**Entregables T-29/T-30/T-31/T-32:** Vitest y Playwright configurados, pipeline de CI, tests unitarios de router, storage y eventos, loader robusto y smoke tests end-to-end de navegación, theming, historial y cleanup.
...
**Estado actual:** En progreso. T-33 y T-34 completados; T-35 y T-36 pendientes.

**Entregables T-33/T-34:** `EventMap` compartido, event bus tipado por topic, validación runtime de eventos y validación fail-closed del `config-map` con allowlist de orígenes.
